...
{
	shader_t* toy_sh = (shader_t*)malloc(sizeof(shader_t));
	...
	model_load(&hexagon, "C:/Users/al7ar/DEV/scop/assets/models/42_resources/42.obj");
	model_load(&sphere, "C:/Users/al7ar/DEV/scop/assets/models/42_resources/teapot.obj");
	model_load(&teapot2 , "C:/Users/al7ar/DEV/scop/assets/models/42_resources/teapot2.obj");
...
void update_default_scene(scene_t* scene)
{
	entity_t* e1 = scene->entity_lst->content;
	entity_t* e2 = scene->entity_lst->next->content;
	entity_t* e3 = scene->entity_lst->next->next->content;
