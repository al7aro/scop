...
/* INPUT CALLBACKS */
scene_t* placeholder_scene_create(const char* scene_name)
{
	...
	model_t* entity_model; model_load(&entity_model, SCOP_INSTALL_PATH"/assets/models/placeholder/untitled.obj");
